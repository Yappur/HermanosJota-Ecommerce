...
const ProductosDestacados = ({ onNavigate }) => {
  ...
  if (loading) {
    return (
      <section className="featured-products" id="productos" aria-labelledby="products-title">
        <div className="container">
          ...
          <div className="loading active" aria-live="polite" aria-label="Cargando productos">
